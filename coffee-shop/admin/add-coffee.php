            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $image_name = "coffee-Name-".rand(0000,9999).".".$ext; //New Image Name May Be "coffee-Name-657.jpg"
                        ...
                        //Finally Uppload the coffee image
                        ...
                        if($upload==false)
                        {
                            ...
                            //REdirect to Add coffee Page with Error Message
                            $_SESSION['upload'] = "<div class='error'>Failed to Upload Image.</div>";
                            header('location:'.SITEURL.'admin/add-coffee.php');
                            //STop the process
                            die();
                        }
                ...
                //4. Redirect with MEssage to Manage coffee page
                if($res2 == true)
                {
